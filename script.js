    ...
    try {
        ...
        if (data.cod === 200) {
            ...
            switch(data.weather[0].main){
                case 'Clouds':
                    weather_img.src = "Weather-forecasting-project/cloud.png";
                    break;
                case 'Clear':
                    weather_img.src = "Weather-forecasting-project/clear.png";
                    break;
                case 'Rain':
                    weather_img.src = "Weather-forecasting-project/rain.png";
                    break;
                case 'Mist':
                    weather_img.src = "Weather-forecasting-project/mist.png";
                    break;
                case 'Snow':
                    weather_img.src = "Weather-forecasting-project/snow.png";
                    break;
            }
